...
async def welcome(request: Request, db: Session=Depends(get_db)):
  ...
  return templates.TemplateResponse("chart.html", {"request": request, "top10": top10, "teamsalary": teamsalary, "possalary": possalary, "possalary2": possalary2, "pospie": pospie})
